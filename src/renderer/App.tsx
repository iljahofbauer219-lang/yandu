...
type AppPage = 'dashboard' | 'ebay' | 'ebay-hub' | 'ebay-title' | 'ai-crossborder' | 'compliance-knowledge' | 'ops-knowledge' | 'system-admin' | 'warehouse-dashboard' | 'tasks' | 'ozon' | 'sourcing' | 'comparison' | 'review' | 'catalog' | 'image-studio' | 'realshift' | 'publishing' | 'procurement' | 'finance' | 'ai-support' | 'feishu' | 'ai-advisor' | 'online-advisor' | 'ai-collect' | 'ai-art' | 'ai-video' | 'ai-video-watch' | 'ai-video-resource' | 'ai-tasks' | 'ai-employee' | 'ai-employee-workspace' | 'ai-employee-listing' | 'ai-employee-guardian' | 'ai-planet' | 'ai-hq' | 'amazon-data-source' | 'llm-keys' | 'ai-sample-library' | 'cb-news' | 'ie-browser' | 'ai-warehouse'
