...
> 场景说明：本样本全成本复算可得，但悲观情景全成本贡献利润为负（高采购价 + 高 FBA + 高退货率），不符合下行现金流硬门禁，不建议入场。
...
- 参数与证据：采购价 $6.00（事实｜用户录入）；Amazon佣金 15%、FBA履约费 $5.00、退货损耗 12%、广告 18%、优惠券 $2.50（分析假设｜用户录入，需在全成本阶段以报价/官方计算器复核）。
| 售价情景 | 标准化销售价 | 采购价 | Amazon佣金 | FBA履约费 | 退货损耗 | 广告费 | 优惠券 | 快速市场利润 | 快速利润率 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| P25（200ml） | $25.99 | $6.00 | $3.90 | $5.00 | $3.12 | $4.68 | $2.50 | $0.80 | 3.1% |
| 中位价（200ml） | $27.00 | $6.00 | $4.05 | $5.00 | $3.24 | $4.86 | $2.50 | $1.35 | 5.0% |
| P75（200ml） | $28.50 | $6.00 | $4.28 | $5.00 | $3.42 | $5.13 | $2.50 | $2.18 | 7.6% |
...
|---|---:|---:|---:|---:|---:|
| 悲观（高成本） | $25.99 | $25.20 | $8.80 | -$8.00 | -30.8% |
| 基准（基准成本） | $27.00 | $25.65 | $6.10 | -$4.75 | -17.6% |
| 乐观（低成本） | $28.50 | $26.32 | $4.20 | -$2.02 | -7.1% |
- 成本区间明细（低/基准/高）：包装/质检 $0.80 / $1.00 / $1.40；国内物流 $0.50 / $0.80 / $1.20；头程 $1.50 / $2.00 / $2.80；关税 $0.50 / $0.80 / $1.20；清关 $0.30 / $0.50 / $0.70；入仓 $0.40 / $0.70 / $1.00；仓储 $0.20 / $0.30 / $0.50。
...
- 合规/IP 核验依据：成分均为常见日化原料，无 EPA/FDA 风险。
...
- 最终结论：❌ 不建议入场
- 门禁依据：悲观情景全成本贡献利润为负，未满足下行现金流硬门禁。
...
- 系统入场结论：❌ 不建议入场
- 门禁依据：悲观情景全成本贡献利润为负，未满足下行现金流硬门禁。
- 已复算指标：基准全成本贡献利润率 -17.6%｜悲观全成本贡献利润 -$8.00。
